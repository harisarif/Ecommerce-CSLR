            ...
            <div class="d-flex flex-wrap align-items-center gap-3">
                ...
                <div class="dropdown">
                    <button class="d-flex justify-content-center align-items-center rounded-circle" type="button" data-bs-toggle="dropdown">
                        <img src="{{ asset('assets/images/users/admin.png') }}" alt="image" class="w-40-px h-40-px object-fit-cover rounded-circle">
                    </button>
                    <div class="dropdown-menu to-top dropdown-menu-sm">
                        <div class="py-12 px-16 radius-8 bg-primary-50 mb-16 d-flex align-items-center justify-content-between gap-2">
                            @php($user = auth()->user())
                            <div>
                                <h6 class="text-lg text-primary-light fw-semibold mb-2"> {{ $user->first_name }} {{ $user->last_name }}</h6>
                                <span class="text-secondary-light fw-medium text-sm">{{ $user->role->getName(1) }} {{-- English role name --}}</span>
                            </div>
